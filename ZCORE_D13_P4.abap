...
************************** FIELD SYMBOLS ******************************
"""""""" FIELD SYMBOL :  IS A SPECIAL VARIABLE WHICH IS CAPABLE OF STORING ANY KIND OF DATA AND IT SHOULD BE ALWAYS ENCLOSED IN ANGULAR BRACKETS AND DECLARED USING FIELD-SYMBOLS.
